...
PageObject.prototype = {
  ...
  setUrl: function *(url) {
    ...
    yield sleep(1000) // since 1.7.2, octofree uses longer timeout for loc change
  },
  ...
  isSidebarShown: function *() {
    var hasCssClass = yield this.driver.isElementPresent($css('html.octofree-show'))
  ...
  nodeFor: function (path) {
    return this.one($id('octofree' + path))
  },
...
var controls = {
  ...
  helpPopup       : '.popup',
  toggleButton    : '.octofree_toggle',
  sidebar         : '.octofree_sidebar',
  branchLabel     : '.octofree_header_branch',

  treeView        : '.octofree_treeview',
  treeHeaderLinks : '.octofree_header_repo a',
  treeNodes       : '.jstree .jstree-node',

  optsButton      : '.octofree_opts',
  optsView        : '.octofree_optsview',
  ...
  saveButton      : '.octofree_optsview .btn',

  errorView       : '.octofree_errorview',
  errorViewHeader : '.octofree_errorview .octofree_view_header'
}
