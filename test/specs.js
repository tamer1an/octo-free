  ...
  xdescribe(browser, function () {
    before(function (cb) {
      starx(function *() {
        ...
        po = new PageObject(driver, 'https://github.com/ovity/octofree')
      })(cb)
    })
    ...
    describe('init', function () {
      ...
      yit('should match branches', function *() {
        ...
        yield po.setUrl('https://github.com/ovity/octofree/tree/v1.6.2')
    ...
    describe('main', function () {
      ...
      describe('tree', function () {
        ...
        yit('should show repository information', function *() {
          ...
          assert.equal(yield links[1].getText(), 'octofree')
        })
        ...
        yit('should navigate to code files', function *() {
          ...
          for (var i = 0; i < 3; i++) {
            ...
            assert.equal(yield po.getUrl(), 'https://github.com/ovity/octofree/blob/master/' + someFile.path)
      ...
      describe('opts', function () {
        ...
        describe('values', function () {
          ...
          describe('non-code', function () {
            var pages = [
              'https://github.com/ovity/octofree/issues',
              'https://github.com/ovity/octofree/pulls',
              'https://github.com/ovity/octofree/pulse',
              'https://github.com/ovity/octofree/graphs/contributors'
            ]
